...
'''
we had 80 M and 20 F
of 80: 50 with pneumothorax and 50 without pneumothorax
of 20: 50 with pneumothorax and 50 without pneumothorax

now we want 50 M and 50 F
of 50 M: 80 with pneuhmothrax and 20 wihtout pneumothorax 
of 50 F: 20 with pneuhmothrax and 80 wihtout pneumothorax 
'''
...
female_pn1 = filter_and_sample(frontal_df, 'Female', 0, n=12000)
...
male_pn1 = filter_and_sample(frontal_df, 'Male', 0, n=3000)
...
train_df.to_csv('../biased_pneumothorax_dataset_train.csv', index=False)
val_df.to_csv('../biased_pneumothorax_dataset_val.csv', index=False)
test_df.to_csv('../biased_pneumothorax_dataset_test.csv', index=False)